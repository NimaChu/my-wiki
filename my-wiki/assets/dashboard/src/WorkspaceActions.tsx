...
const labels = {
  en: {
    ...
    universeTitle: "Knowledge universes",
    universeDescription: "Export one universe or preview a package before importing it.",
    wikiPages: "{count} Wiki",
    rawSources: "{count} raw",
    export: "Export",
    exporting: "Exporting",
    download: "Download package",
    importPackage: "Import a universe package",
    rename: "Universe name after import",
  ...
  zh: {
    ...
    addAnother: "继续添加",
    universeTitle: "知识宇宙",
    universeDescription: "导出单个宇宙，或在确认前预览知识包导入内容。",
    wikiPages: "{count} 个 Wiki",
    rawSources: "{count} 条 raw",
    export: "导出",
    exporting: "正在导出",
    download: "下载知识包",
    importPackage: "导入知识宇宙包",
    rename: "导入后的宇宙名",
